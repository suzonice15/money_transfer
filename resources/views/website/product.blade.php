                                ...
                                <div class="product-item-holder size-big single-product-gallery small-gallery">
                                    <div id="owl-single-productg">
                                        <div class="single-product-gallery-item "  >
                                                <img class="xzoom img-responsive"  alt="" src="{{ url('/public/uploads') }}/{{ $product->folder }}/{{ $product->feasured_image }}"  xoriginal="{{ url('/public/uploads') }}/{{ $product->folder }}/{{ $product->feasured_image }}"/>
...
<?php } ?>
                                            ...
                                            <div class="item">
                                                <img class="img-responsive thum_image_hover " width="85" alt="" data-echo="{{ url('/public/uploads') }}/{{ $product->folder }}/{{ $product->galary_image_1 }}"/>
                                            ...
                                            <div class="item">
                                                <img class="img-responsive thum_image_hover " width="85" alt="" data-echo="{{ url('/public/uploads') }}/{{ $product->folder }}/{{ $product->galary_image_2 }}"/>
                                            ...
                                            <div class="item">
                                                <img class="img-responsive thum_image_hover " width="85" alt="" data-echo="{{ url('/public/uploads') }}/{{ $product->folder }}/{{ $product->galary_image_3 }}"/>
                                            ...
                                            <div class="item">
                                                <img class="img-responsive thum_image_hover " width="85" alt="" data-echo="{{ url('/public/uploads') }}/{{ $product->folder }}/{{ $product->galary_image_4 }}"/>
                                            ...
                                            <div class="item">
                                                <img class="img-responsive thum_image_hover " width="85" alt="" data-echo="{{ url('/public/uploads') }}/{{ $product->folder }}/{{ $product->galary_image_5 }}"/>
                                            ...
                                            <div class="item">
                                                <img class="img-responsive thum_image_hover " width="85" alt="" data-echo="{{ url('/public/uploads') }}/{{ $product->folder }}/{{ $product->galary_image_6 }}"/>
                            ...
                            <div class='col-sm-6 col-md-7 product-info-block'>
                                <div class="product-info">
                                    ...
                                    <p class="btn btn-success">Product Code: {{$product->sku}}</p>
                                    <?php
                                    if(isset($shop_link)){
                                    ?>
                                    <h4>Shop : <a href="{{URL::to('shop/'.$shop_link)}}">{{$shop_name}}</a></h4>
                                    <?php }?>
                                  ...
                                  @money($sell_price)
                                    ...
                                    <div class="quantity-container info-container">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <a data-product_id="{{ $product->product_id}}" data-picture="{{ url('/public/uploads') }}/{{ $product->folder }}/small/{{ $product->feasured_image}}" class="btn btn-primary add_to_cart"
                                                    href="javascript:void(0)" >  ADD TO CART</a>
                                                <a href="javascript:void(0)" data-product_id="{{ $product->product_id}}" data-picture="{{ url('/public/uploads') }}/{{ $product->folder }}/small/{{ $product->feasured_image}}" class="btn btn-success buy-now-cart icon"
                                                   > BUY NOW  </a>
                                                ...
                                                <div class="col-sm-6  col-xs-12 review-left" style="padding-left: 0;">
                                                    ...
                                                    <form class="form-vertical reviewform"  >
                                                        ...
                                                        <div class="form-group">
                                                            <input type="hidden" name="name" id="name" class="form-control field field-name" value="{{Session::get('name')}}" placeholder="Name" style="width: 100% !important;">
                                                        </div>
                                                        <div class="form-group">
                                                            <input type="hidden" name="email" id="email" class="form-control field field-email" value="{{Session::get('email')}}" placeholder="Email" style="width: 100% !important;">
                                                        </div>
                                                        <div class="form-group">
                                                            <textarea rows="3" name="comment" id="comment" class="form-control field field-comment" placeholder="Comments"></textarea>
                                                        </div>

                                                        <input type="hidden" name="product_id" id="product_review_id" value="{{$product->product_id}}">
                                                 ...
                                                 <?php } else {  ?>
                                                 <a href="{{URL::to('customer/login')}}" target="_blank" class="btn btn-success">To Write A Review Login First</a>
                                                <?php }?>
...
$products = DB::table('product')->select('product.product_id', 'product_title', 'product_name', 'discount_price', 'product_price', 'folder', 'feasured_image', 'sku')->join('product_category_relation', 'product.product_id', '=', 'product_category_relation.product_id')
        ->where('product_category_relation.category_id', $home_cat_section)->where('status','=',1)->orderBy('modified_time','desc')->get();
?>
...
<script type="text/javascript" src="{{ asset('assets/font_end/')}}/dist/jquery.floating-social-share.min.js"></script>
<link rel="stylesheet" type="text/css" href="{{ asset('assets/font_end/')}}/dist/jquery.floating-social-share.min.css" />
