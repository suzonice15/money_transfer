...
<head>
    ...
    <meta property="og:type" content="{{$seo_description}}"/>
    ...
    <meta property="og:site_name" content="{{$seo_keywords}}"/>
...
<header class="header-style-1">
            ...
            <div class="header-top-inner">
                <div class="cnt-account">
                    <ul class="list-unstyled">
                        ...
                        <li><a href="{{url('/checkout')}}"><i class="icon fa fa-shopping-cart"></i>Checkout</a></li>

                        <?php

                        if($user_id){
                        ?>
                         <li><a href="{{URL::to('/customer/login')}}"><i class="icon fa fa-lock"></i>Dashboard</a></li>
                   <?php } else { ?>
                        <li><a href="{{URL::to('/customer/login')}}"><i class="icon fa fa-lock"></i>Login</a></li>
    ...
    <div class="topnav">
        <a href="{{url('/')}}" class="top_welcome">Welcome to Money Transfer
        </a>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-2 mobile-phone ">
                    ...
                    <h2 style="color: black;font-weight: bold;margin-top: 13px;margin-left: -61px;"><img style="width: 50px;" src="{{url('/public/')}}/call.gif"><?=get_option('phone')?></h2>
                </div>
