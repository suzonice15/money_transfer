                    ...
                    <div class="panel-body">
                            ...
                            <div class="checkoutstep">
                                <div class="form-group">
                                    ...
                                    <input required="" type="text" id="customer_name" name="customer_name" value="<?php echo e($user_row->name); ?>" class="form-control " placeholder="Type Your Name">
                                </div>
                                <div class="form-group">
                                    <label for="billing_name"><b>Mobile</b></label>
                                    <span style="color:red;font-size: 18px;margin-top: -7px;position: absolute;">*</span>
                                    <input required="" type="text" id="customer_phone" name="customer_phone" value="<?php echo e($user_row->phone); ?>" class="form-control " placeholder="Type Your Mobile">
                                    <p id="customer_phone_error" class="text-danger"></p>
                                </div>
                                <div class="form-group" >
                                    <label for="billing_name"><b>Email</b></label>

                                    <input type="text" name="customer_email" id="customer_email" value="<?php echo e($user_row->email); ?>" class="form-control " placeholder="Email">
                                ...
                                <div class="form-group">
                                    ...
                                    <span style="color:red;font-size: 18px;margin-top: -7px;position: absolute;">*</span>
                                    <textarea  required=""  name="customer_address"  class="form-control" placeholder="Type Your Address"><?php echo e($user_row->address); ?></textarea>
...
<center>
    ...
    <a class="btn btn-success" style="text-align:center" href="<?php echo e(url('/')); ?>/customer/login">Login</a>
...
<?php echo $__env->make('website.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Xampp\htdocs\money_transfer\resources\views/website/checkout.blade.php ENDPATH**/ ?>