                    ...
                    <div class="box-body" style="padding: 28px;">
                        ...
                        <div class="form-group ">
                            ...
                            <textarea class="form-control" rows="2"
                                      name="map"><?=get_option('map')?></textarea>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bestearnidea/public_html/taka2/resources/views/admin/setting/deafualt_setting.blade.php ENDPATH**/ ?>