...
<!--                    <div class="module-body">-->
<!--                        <ul class='list-unstyled'>-->
<!--                            <li class="first"><a href="<?php echo e(url('/')); ?>/shopping-guide" title="About us">Shopping Guide</a></li>-->
<!--                            <li class=" last"><a href="<?php echo e(url('/')); ?>/contact-us" title="Suppliers">Contact Us</a></li>-->
<!--                        </ul>-->
<!--                    </div>-->
<!--                </div>-->
<!--            </div>-->
    ...
    <div class="copyright-bar">
        <div class="container-fluid">
            ...
            <div class="col-xs-12 col-sm-6 no-padding">
                <h5 style="color:white">@copyright  2020 - <?=date('Y')?> Devoloped by <a  style="color:white" href="" target="_blank">Developed by IT</a></h5>
            </div>
        </div>
    </div>
</footer>
...
<?php /**PATH /home/bestearnidea/public_html/taka2/resources/views/website/includes/footer.blade.php ENDPATH**/ ?>