        ...
        <tr>
            ...
            <td>
                <?php if($category->product_code==null) {?>
                    <img width="30" src="<?php echo e(url('/public')); ?>/uploads/<?php echo e($category->media_path); ?>">
                <?php }  else { ?>
...
<?php /**PATH /home/rsohojjp/public_html/resources/views/admin/media/pagination.blade.php ENDPATH**/ ?>